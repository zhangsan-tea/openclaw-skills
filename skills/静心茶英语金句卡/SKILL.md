...
⚠️ 「中英对照双语卡」**不属于本技能**，它做的是**静心茶金句卡**（纯中文金句卡）的双语变体，
只是沿用了本技能的排版经验。归属与做法见 `静心茶海报` 技能。

**两者的品牌标签不同，不可混用**：
- 本技能（跟着波密·庄西学英语，五层信息：英文原文/机翻/庄西译/对比点拨/觉察提示）→ 才用 `跟着波密 · 庄西学英语` 标签
- 静心茶金句卡及其双语变体 → **只有** `静心茶` 竖排角标 + `日期 · 主题` 标签，**不加系列标签**

（2026-09-14 踩坑：给金句卡双语版误加了 `跟着波密 · 庄西学英语` 标签，被用户指出「那是另一个项目」。）
